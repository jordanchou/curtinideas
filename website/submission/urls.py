...
urlpatterns = [
                ...
                url(r'^upvotes(?P<pk>\d+)/(?P<slug>.*)/$', views.update_sub_upvotes, name='submission_upvotes'),
                url(r'^downvotes(?P<pk>\d+)/(?P<slug>.*)/$', views.update_sub_downvotes, name='submission_downvotes'),
                ...
                url(r'^filter_by_science/$', views.submission_list_science, name = 'submission_list_science'),
                url(r'^filter_by_engineering/$', views.submission_list_engineering, name = 'submission_list_engineering'),
                ...
                url(r'^filter_by_arts/$', views.submission_list_arts, name = 'submission_list_arts'),
                url(r'^search/$', views.search, name = 'submission_search'),
                url(r'^comment/upvotes(?P<pk>\d+)/(?P<slug>.*)/$', views.update_com_upvotes, name='comment_upvotes'),
                url(r'^comment/downvotes(?P<pk>\d+)/(?P<slug>.*)/$', views.update_com_downvotes, name='comment_downvotes'),
              ]
